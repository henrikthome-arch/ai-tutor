# AI Tutor PoC Setup Instructions

## Prerequisites Installation

Since you're new to development, here are the step-by-step instructions to get everything running:
...
4. Add that folder to your Windows PATH, or run ngrok from that directory
...
## Alternative: Simple Python Server (if Node.js installation fails)

If you have Python installed (which comes with Windows), I can create a simpler Python version:

<write_to_file>
<path>simple-server.py</path>
