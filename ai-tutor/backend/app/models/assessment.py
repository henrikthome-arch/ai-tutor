"""
StudentSubject model - replaces old Assessment and StudentProgress models
"""
...
# Keep the old Assessment model for backward compatibility during transition
# TODO: Remove this after migration is complete
class Assessment(db.Model):
    """Legacy Assessment model - to be removed after migration"""
